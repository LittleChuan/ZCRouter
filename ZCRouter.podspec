...
Pod::Spec.new do |s|
  s.name             = 'ZCRouter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZCRouter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ZackXXC/ZCRouter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ZackXXC' => 'Zack@littlelights.ai' }
  s.source           = { :git => 'https://github.com/ZackXXC/ZCRouter.git', :tag => s.version.to_s }
